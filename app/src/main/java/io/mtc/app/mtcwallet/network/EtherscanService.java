...
import io.mtc.app.mtcwallet.utils.EtherscanServiceResponseParser;
...
public class EtherscanService extends EthService {
    ...
    @Override
    public void getTransactionReceipt(String txhash) {

    }

    @Override
    public void getWalletCoinList(String walletAddress) {

    }

    @Override
    public void getTransactionList(String walletAddress, String contractAddress, long pageIndex, long pageSize) {
        ...
        backgroundHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    e.printStackTrace();
                    listener.onSendRawTransactionError(transactionData, e, "钱包密码错误,请重新输入!");
                }
            }
        });
    }
