...
public class EthWalletGenSuccessActivity extends AppCompatActivity implements View.OnClickListener, DialogFragmentCallback {
    ...
    private TextView tv_name, tv_address, tv_password, tv_password_hit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eth_wallet_gen_success);
    ...
    public static void startActivity(Context context, EthWalletInfo ethWalletInfo, String password) {
        Intent intent = new Intent(context, EthWalletGenSuccessActivity.class);
        intent.putExtra(KEY_WALLET_INFO, ethWalletInfo);
        intent.putExtra(KEY_PASSWORD, password);
        context.startActivity(intent);
    }

    public static void startActivityForResult(Activity activity, EthWalletInfo ethWalletInfo, String password, int requestCode) {
        Intent intent = new Intent(activity, EthWalletGenSuccessActivity.class);
        intent.putExtra(KEY_WALLET_INFO, ethWalletInfo);
        intent.putExtra(KEY_PASSWORD, password);
